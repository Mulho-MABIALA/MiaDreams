                    ...
                    {collections.map((col, ci) => (
                        <div key={col._id} className="reveal">
                            ...
                            <div className={`grid grid-cols-1 lg:grid-cols-2 gap-0 mb-10 overflow-hidden border border-white/[0.06] ${ci % 2 === 1 ? 'lg:[&>*:first-child]:order-2' : ''}`}>
                                {/* Image */}
                                <div className="relative overflow-hidden min-h-[200px] sm:min-h-[280px] lg:min-h-[320px]">
                                    {col.image ? (
                                            ...
                                            <div className="overflow-hidden mb-3 relative" style={{ background: '#111' }}>
                                                {prod.image
                                                    ? <img src={imgSrc(prod.image)}
                                                           className="w-full h-[180px] sm:h-[220px] lg:h-[260px] object-cover object-top transition-transform duration-700 group-hover:scale-105"
                                                           alt={prod.name} loading="lazy" />
                                                    : <div className="w-full h-[180px] sm:h-[220px] lg:h-[260px] bg-[#141414] flex items-center justify-center">
