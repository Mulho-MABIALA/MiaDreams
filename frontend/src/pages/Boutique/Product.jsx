                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="pt-6 border-t border-white/[0.08] space-y-4">
                                <p className="font-lastica text-[10px] tracking-[4px] text-white/70 uppercase mb-3">Informations</p>
                                {[
                    ...
                    {similar.length > 0 && (
                        <section className="mt-24 pt-16 border-t border-white/[0.07]">
                            <div className="flex items-center gap-6 mb-12">
                                <div>
                                    <p className="font-lastica text-[10px] tracking-[5px] text-white/70 uppercase mb-1">Vous aimerez aussi</p>
