                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 mb-8">
                                ...
                                {/* Voir panier */}
                                <Link to="/panier"
                                    className="flex-1 py-4 font-lastica text-[9px] tracking-[4px] uppercase text-center border transition-all duration-200 hover:border-gold/60 hover:text-gold/90"
