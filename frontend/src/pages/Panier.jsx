        ...
        <Layout title="Mon panier — MIA DREAMS">
            <div className="min-h-screen bg-[#080808] flex flex-col items-center justify-center gap-5 px-6">
                <div className="w-16 h-16 border border-white/[0.15] flex items-center justify-center mb-2">
                    <svg className="w-6 h-6 text-white/60" fill="none" stroke="currentColor" strokeWidth="1.2" viewBox="0 0 24 24">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex justify-between items-start gap-3 mb-1">
                                                ...
                                                <button onClick={() => removeItem(item.key)}
                                                    className="text-white/45 hover:text-white/40 transition-colors flex-shrink-0 mt-0.5">
                            ...
                            <div className="flex items-center justify-between mt-8 pt-6 border-t border-white/[0.08]">
                                ...
                                {confirmClear ? (
                                    ...
                                    <button
                                        ...
                                        className="font-lastica text-[10px] tracking-[3px] text-white/30 hover:text-red-400/60 transition-colors uppercase flex items-center gap-1.5">
                                ...
                                <div className="mt-6 pt-5 border-t border-white/[0.08]">
                                    ...
                                    <div className="flex items-center justify-center gap-3 flex-wrap">
                                        ...
                                        <div className="flex items-center gap-1 opacity-65 hover:opacity-90 transition-opacity">
                                            ...
                                            <span className="font-lastica text-[9px] tracking-[1px] text-white/70 uppercase">Wave</span>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-1 opacity-65 hover:opacity-90 transition-opacity">
                                            ...
                                            <span className="font-lastica text-[9px] tracking-[1px] text-white/70 uppercase">Orange</span>
                                        </div>
                                        <div className="w-px h-3 bg-white/[0.12]" />
                                        {/* MTN */}
                                        <div className="flex items-center gap-1 opacity-65 hover:opacity-90 transition-opacity">
                                            ...
                                            <span className="font-lastica text-[9px] tracking-[1px] text-white/70 uppercase">MTN</span>
                                        </div>
                                        <div className="w-px h-3 bg-white/[0.12]" />
                                        {/* Espèces */}
                                        <div className="flex items-center gap-1 opacity-65 hover:opacity-90 transition-opacity">
                                            ...
                                            <span className="font-lastica text-[9px] tracking-[1px] text-white/70 uppercase">Espèces</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
